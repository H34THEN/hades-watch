...
export type AuditAction =
  ...
  | "lore.publish"
  | "lore.unlock"
  | "archive.submit.article"
  | "archive.submit.repo"
  | "archive.comment.create"
  | "archive.item.status"
  | "archive.comment.hide"
  | "deaddrop.create"
  | "deaddrop.view"
  | "mission.create"
  | "mission.update"
  ...
  | "mission.review.reject"
  | "mission.badge.verify"
  | "cipher.solved"
  | "user.disable"
  | "user.enable"
  | "user.role.assign"
  ...
  | "forum.reaction"
  | "forum.report.create"
  | "forum.profile.update"
  | "forum.signature.create"
  | "forum.identity.moderate"
