...
export const metadata = { title: "Banner Relay // Old-Web Sigil Builder" };

export default async function ForumBannerBuilderPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-mono text-2xl tracking-widest uppercase text-primary">
            BANNER RELAY // OLD-WEB SIGIL BUILDER
          </h1>
          <p className="mt-2 text-muted-foreground">
            Build an old-web forum banner for your signature using safe presets and tokens.
          </p>
        </div>
      ...
      <TerminalPanel title="forum.banner.builder">
        <ForumSignatureBuilder assetType="BANNER" />
      </TerminalPanel>
    </div>
  );
}
